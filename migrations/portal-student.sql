...
(
    id bigint NOT NULL GENERATED ALWAYS AS IDENTITY ( INCREMENT 1 START 100001 MINVALUE 1 MAXVALUE 9223372036854775807 CACHE 1 ),
...
-- DROP TABLE IF EXISTS public.user_portal;
...
ALTER TABLE IF EXISTS public.user_portal
    OWNER to postgres;
...
INSERT INTO course (id, description, fee, title)
